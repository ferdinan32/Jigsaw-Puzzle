...
public class JigsawPuzzle : MonoBehaviour {
    ...
    public Texture[] image;                // will contain the jigsaw projected picture                                 包含拼图的图片                						
    public Vector2 size;     // how many pieces will this puzzle have (x,y)								 size piece的总数量	
    ...
    private void SetSample()
    {
        ...
        sampleImage.GetComponent<Renderer>().material.mainTexture = image[GameManager.instance.levelPuzzle];
    ...
    private void InitPiece(GameObject puzzlePiece, Vector2 pos)
    {
        ...
        puzzlePiece.GetComponent<Renderer>().material.mainTexture = image[GameManager.instance.levelPuzzle];
